namespace Inbound_Status_Doc_X12_Process.Maps {
    ...
    public sealed class Map_810_997 : global::Microsoft.XLANGs.BaseTypes.TransformBase {
...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var userCSharp"" version=""1.0"" xmlns:ns0=""http://schemas.microsoft.com/BizTalk/EDI/X12/2006"" xmlns:userCSharp=""http://schemas.microsoft.com/BizTalk/2003/userCSharp"">
  ...
  <xsl:template match=""/"">
    <xsl:apply-templates select=""/ns0:X12_00401_810"" />
  </xsl:template>
  <xsl:template match=""/ns0:X12_00401_810"">
    <xsl:variable name=""var:v2"" select=""userCSharp:StringTrimRight(&quot;IN&quot;)"" />
    <xsl:variable name=""var:v3"" select=""userCSharp:StringTrimRight(&quot;1&quot;)"" />
    <xsl:variable name=""var:v4"" select=""userCSharp:StringTrimRight(&quot;810&quot;)"" />
    ...
    <ns0:X12_00401_997>
      ...
      <ns0:AK2Loop1>
        <ns0:AK2>
          ...
          <xsl:if test=""ns0:BIG/BIG04"">
            <AK202>
              <xsl:value-of select=""ns0:BIG/BIG04/text()"" />
            </AK202>
          </xsl:if>
        </ns0:AK2>
        <ns0:AK3Loop1>
